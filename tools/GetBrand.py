...
# 例如 https://search.kaola.com/category/1470.html
...
# 步骤:
#   1. 获取所有栏目
# brandboxwrap > div.hdbrands.j-tagwrap.autoheight.multi-mode > div.hdbrands2.ctag > div
url = "https://search.kaola.com/category/1470.html"
...
f = open('KaoLaBrand.txt', 'w', encoding='utf-8', errors='ignore')
f.write(resAll )
f.close()


def hello():
    print("GetBrand hello method")